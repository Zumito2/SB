...
import { getJobs, getJobsId, getJobsDate, getJob, startJob, endJob, getJobsFecha, createJob, updateJob, deleteJob, getJobsByUser, createUserJob, updateUserJob, guardarNota, getJobsPendiente} from '../controllers/jobs.controller.js';
