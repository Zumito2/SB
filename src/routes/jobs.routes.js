...
import { getJobs, getJobsId, getJobsDate, getJob, startJob, endJob, getJobsFecha, createJob, updateJob, deleteJob, getJobsByUser, createUserJob, updateUserJob, getLastJob} from '../controllers/jobs.controller.js';
...
router.get('/lastJob', authenticateToken, getLastJob);
